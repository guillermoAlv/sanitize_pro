...
import sty from "./PlasmicHeaderButton.module.css"; // plasmic-import: CqpC71myoRuHP/css
...
function PlasmicHeaderButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box___66AMy)}>
        <div className={classNames(defaultcss.all, sty.box__p2NxA)}>
          <p.PlasmicSlot
            defaultContents={"Raw Event Viewer"}
            value={args.children}
